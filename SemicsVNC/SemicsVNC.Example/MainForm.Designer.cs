namespace SemicsVNC.Example
{
    partial class MainForm
    {
        ...
        {
            SemicsVNC.Vnc.VncClient vncClient1 = new SemicsVNC.Vnc.VncClient();
            ...
            this.vncControl = new SemicsVNC.Windows.Forms.VncControl();
            ...
            this.Name = "MainForm";
            this.Text = "SemicsVNC - Example VNC Client";
