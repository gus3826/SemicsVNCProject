...
namespace SemicsVNC.Utility
{
    ...
    public static class User32
    {
        ...
        /// Function that can be used to simulate a mouse.
        /// </summary>
        /// <param name="bVk">Vk</param>
        /// <param name="bScan">Scan</param>
        /// <param name="dwFlags">Flags</param>
        /// <param name="dwExtraInfo">Extra info for X buttons</param>
        [DllImport("user32.dll", EntryPoint = "keybd_event")]
        public static extern void Keybd_event(uint bVk, byte bScan, int dwFlags, int dwExtraInfo);
